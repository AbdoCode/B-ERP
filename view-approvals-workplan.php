<?php
    ...
    include 'navbar.php';
?>
<div class="view-approvals-workplan">
    <div class="col-sm-9">
        <div class="workplan">
    ...
    <div class="col-sm-3">
        <div class="aside">
            <div class="info row">
                <label class="col-sm-6">Class:</label>
                <span class="col-sm-6">A</span>
            </div>
            <div class="info row">
                <label class="col-sm-6">Subject:</label>
                <span class="col-sm-6">English</span>
            </div>
            <div class="info row">
                <label class="col-sm-6">Teacher:</label>
                <span class="col-sm-6">Asmaa</span>
            </div>
