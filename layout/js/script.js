...
$(function () {
    ...
    function colorize($target) {
        $($target).each(function () {
            ...
            } else if ($(this).html() === "In progress" || $(this).html() === "Not Approved") {
    ...
    $(".sumBudget").on('change', function () {
        var temp = 0;
        $(".sumBudget").each(function () {
    ...
    $(".add-number").on('click', function () {
        var numberOfItem = parseInt($(this).siblings(".SumoSelect").children(".number-of-item").val());
